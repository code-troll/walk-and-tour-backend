...
export class InitialSchema1710000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE "tours" (
        ...
        "cover_media_ref" character varying(255),
        ...
        "cancellation_type" character varying(30) NOT NULL,
        "duration_minutes" integer NOT NULL,
        "start_point" jsonb NOT NULL,
        "end_point" jsonb NOT NULL,
        "itinerary_variant" character varying(20) NOT NULL,
    ...
    await queryRunner.query(`
      CREATE TABLE "tour_translations" (
        ...
        "translation_status" character varying(20) NOT NULL,
        "publication_status" character varying(20) NOT NULL,
        "is_hidden" boolean NOT NULL DEFAULT false,
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "tour_tags" DROP CONSTRAINT "FK_tour_tags_tag"`);
    await queryRunner.query(`ALTER TABLE "tour_tags" DROP CONSTRAINT "FK_tour_tags_tour"`);
    await queryRunner.query(
      `ALTER TABLE "tour_translations" DROP CONSTRAINT "FK_tour_translations_language"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_translations" DROP CONSTRAINT "FK_tour_translations_tour"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tour_itinerary_stops" DROP CONSTRAINT "FK_tour_itinerary_stops_tour"`,
    );
