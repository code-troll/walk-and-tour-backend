...
export class BlogPosts1710000000002 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "blog_post_tags" DROP CONSTRAINT "FK_blog_post_tags_tag"`,
    );
    await queryRunner.query(
      `ALTER TABLE "blog_post_tags" DROP CONSTRAINT "FK_blog_post_tags_blog_post"`,
    );
    await queryRunner.query(
      `ALTER TABLE "blog_post_translations" DROP CONSTRAINT "FK_blog_post_translations_language"`,
    );
    await queryRunner.query(
      `ALTER TABLE "blog_post_translations" DROP CONSTRAINT "FK_blog_post_translations_blog_post"`,
    );
